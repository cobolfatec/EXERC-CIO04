      ...
      *--------------------------------------------------------------*
       010-INICIAR.
           ...
           DISPLAY "CALCULO DO PRECO DE UM TERRENO QUADRADO"
      ...
      *--------------------------------------------------------------*
       030-PROCESSAR.
           ...
           IF AS-VAL-VENDA >  1500000,00
              ...
              MOVE "ALTO PADRAO"   TO   WS-TEXTO
           ELSE
              COMPUTE AS-COMISSAO = AS-VAL-VENDA * 0,06
              MOVE "MEDIO PADRAO"  TO   WS-TEXTO
           END-IF
